...
for name in ["httpx","urllib3","sentence_transformers","chromadb","sqlalchemy.engine","services.vector_service"]:
...
with open("tests/tmp_confidence_eval_results.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=2)

print("OK: tests/tmp_confidence_eval_results.json")
